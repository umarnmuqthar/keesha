...
export default function AuthEntry({ onEmailSelect }) {
    return (
        <div className="space-y-6">
            <button
                onClick={onEmailSelect}
                className="w-full bg-[#FF385C] hover:bg-[#ff2449] text-white font-semibold py-3.5 px-4 rounded-xl transition-all duration-200 shadow-[0_4px_14px_rgba(255,56,92,0.2)] flex items-center justify-center gap-2 group transform active:scale-[0.98]"
            >
