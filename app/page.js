...
import LoanProgressWidget from './components/LoanProgressWidget';
import UpcomingPaymentsList from './components/UpcomingPaymentsList';
import TopSubscriptionsWidget from './components/TopSubscriptionsWidget';
...
async function getDashboardData(userId) {
    ...
    try {
        ...
        for (const doc of loanSnapshot.docs) {
            ...
            // Fetch payments to calculate progress
            ...
            loans.push({ ...loanData, payments, totalPaid: paidAmount });
        }
    } catch (e) {
